    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div class="mt-2 md:mt-0 md:ml-4">
                    <span
                        ...
                        Amount: {{ config('currencies.'.Auth::user()->currency, '$') }}{{ number_format($amount) }} {{
                        Auth::user()->currency }}
                    </span>
                </div>
            </div>
        ...
        <div class="p-6">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p>You are to make payment of
                                <strong>{{$settings->currency}}{{number_format($amount)}}</strong> using your selected
                                payment method. Screenshot and upload the proof of payment.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center mb-6">
                <div
                    class="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center w-full max-w-xs">
                    ...
                    <div class="bg-white p-2 rounded-lg border border-gray-200 mb-3 w-full flex justify-center">
                        ...
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data={{urlencode($qrContent)}}"
                            alt="Payment QR Code" class="w-48 h-48">
                    </div>
            ...
            <div class="space-y-6">
                ...
                @if ($payment_mode->name == "Bitcoin" or $payment_mode->name == "Litecoin" or $payment_mode->name ==
                "Ethereum")
                ...
                <div class="space-y-6">
                    ...
                    <div id="paystack" class="bg-gray-50 rounded-lg border border-gray-200 p-5">
                        <div class="flex flex-col items-center">
                            ...
                            <form method="POST" action="{{ route('pay.paystack') }}" accept-charset="UTF-8"
                                ...
                                <button type="submit"
                                    class="w-full py-3 px-4 flex items-center justify-center rounded-lg bg-success-600 hover:bg-success-700 text-white font-medium transition-colors">
                    ...
                    <div class="bg-gray-50 rounded-lg border border-gray-200 p-5">
                        <div class="flex flex-col items-center mb-4">
                            ...
                            <form id="payment-form" class="w-full max-w-md">
                                ...
                                <button id="stripesubmit"
                                    class="w-full py-3 px-4 flex items-center justify-center rounded-lg bg-primary-600 hover:bg-primary-700 text-white font-medium transition-colors">
                        ...
                        <div class="hidden" id="stripesuccess">
                            <div
                                class="p-4 bg-success-50 border border-success-200 rounded-lg text-success-800 text-center">
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        ...
                                        <button type="button" onclick="copyToClipboard(this)"
                                            data-value="{{$payment_mode->bankname}}"
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        <input type="text" value="{{$payment_mode->account_name}}"
                                            ...
                                            readonly />
                                        <button type="button" onclick="copyToClipboard(this)"
                                            data-value="{{$payment_mode->account_name}}"
                                            class="inline-flex items-center justify-center px-3 py-2 border border-l-0 border-gray-200 rounded-r-lg bg-gray-50 hover:bg-gray-100 text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors">
                                            <i data-lucide="copy" class="h-4 w-4"></i>
                                        </button>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        <input type="text" value="{{$payment_mode->account_number}}"
                                            ...
                                            readonly />
                                        <button type="button" onclick="copyToClipboard(this)"
                                            data-value="{{$payment_mode->account_number}}"
                                            class="inline-flex items-center justify-center px-3 py-2 border border-l-0 border-gray-200 rounded-r-lg bg-gray-50 hover:bg-gray-100 text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors">
                                            <i data-lucide="copy" class="h-4 w-4"></i>
                                        </button>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        <input type="text" value="{{$payment_mode->swift_code}}"
                                            ...
                                            readonly />
                                        <button type="button" onclick="copyToClipboard(this)"
                                            data-value="{{$payment_mode->swift_code}}"
                                            class="inline-flex items-center justify-center px-3 py-2 border border-l-0 border-gray-200 rounded-r-lg bg-gray-50 hover:bg-gray-100 text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors">
                                            <i data-lucide="copy" class="h-4 w-4"></i>
                                        </button>
                                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div id="auto-upload-area"
                            ...
                            <div id="auto-preview-container" class="hidden flex flex-col items-center justify-center">
                                <img id="auto-image-preview" src="#" alt="Preview"
                                ...
                                <p class="text-sm font-medium text-gray-700 flex items-center">
                                    ...
                                    <button type="button" id="auto-remove-file"
                                        class="ml-2 text-red-500 hover:text-red-700">
                                        <i data-lucide="x-circle" class="h-5 w-5"></i>
                                    </button>
                                </p>
                            </div>
                            <input id="proof-upload-auto" class="hidden" name="proof" type="file" required
                                accept="image/*,.pdf">
                        </div>
                    </div>
            ...
            @endif
            @if($settings->deposit_option == "manual" and $payment_mode->name != "Paystack" and $payment_mode->name !=
            "Stripe" and $payment_mode->name != "Paypal" and $title !="Complete Payment")
            <div class="mt-8">
                <form method="post" action="{{route('savedeposit')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6">
                        ...
                        <div id="manual-upload-area"
                            ...
                            <div id="manual-preview-container" class="hidden flex flex-col items-center justify-center">
                                <img id="manual-image-preview" src="#" alt="Preview"
                                    class="max-h-48 max-w-full mb-3 rounded-lg shadow-sm">
                                <p class="text-sm font-medium text-gray-700 flex items-center">
                                    <span id="manual-file-name">filename.jpg</span>
                                    <button type="button" id="manual-remove-file"
                                        class="ml-2 text-red-500 hover:text-red-700">
                                        <i data-lucide="x-circle" class="h-5 w-5"></i>
                                    </button>
                                </p>
                            </div>
                            <input id="proof-upload-manual" class="hidden" name="proof" type="file" required
                                accept="image/*,.pdf">
                        </div>
                    </div>
                    <input type="hidden" name="amount" value="{{$amount}}">
